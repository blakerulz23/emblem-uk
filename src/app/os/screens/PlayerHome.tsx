    ...
    <>
      ...
      <div onMouseMove={actions.tiltMove} onMouseLeave={actions.tiltReset} style={{ position: 'relative', background: 'var(--os-card)', borderRadius: 22, overflow: 'hidden', boxShadow: '0 12px 30px -14px rgba(0,0,0,.22)', marginBottom: 22, minHeight: 200 }}>
        ...
        <div style={{ position: 'relative', padding: '20px 52px 18px 22px', display: 'flex', justifyContent: 'space-between' }}>
          <div>
            <div style={{ fontFamily: 'Barlow Condensed', fontWeight: 700, letterSpacing: '.1em', fontSize: 13, color: '#E97435', marginBottom: 2 }}>MIDFIELDER</div>
            <div style={{ fontFamily: 'Roboto', fontWeight: 900, fontSize: 30, lineHeight: .98, color: 'var(--os-ink)' }}>OLLIE<br />HARRISON</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '12px 0 4px' }}>
              ...
              <span style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 12.5, color: '#6B6357' }}>Curzon Ashton<br />Juniors U10</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 8, fontFamily: 'Roboto', fontWeight: 600, fontSize: 12, color: 'var(--os-muted)' }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#8A8378" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M3 9h18M8 2v4M16 2v4" /></svg>
              2026 / 27 SEASON
            </div>
            <div data-tiltz="30" style={{ marginTop: 14 }}>
              ...
              <div style={{ fontFamily: 'Roboto', fontWeight: 900, fontSize: 40, color: '#E97435', lineHeight: .9 }}>87</div>
            </div>
          </div>
        </div>
        <div data-tiltz="40" style={{ position: 'absolute', right: 38, top: 0, bottom: 0, width: 180, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', overflow: 'hidden' }}>
          <img src={`${osAssetPath}/player-ollie.png`} alt="Ollie Harrison" style={{ height: '100%', width: 'auto', objectFit: 'contain', objectPosition: 'bottom' }} />
        </div>
      </div>
