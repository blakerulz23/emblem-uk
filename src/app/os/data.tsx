...
export const SQUAD: SquadPlayer[] = [
  ...
  { id: 'theo', name: 'Theo Nkosi', num: 11, pos: 'Winger', status: 'Add recognition', guardianStatus: 'none', guardianCount: 0, latestInviteExpiresAt: null, hasManageableInvite: false, secondaryPosition: null, footballAgeGroup: null, heightCm: null, preferredFoot: null, coachFieldsUpdatedAt: null, seasonFocus: [], strengths: [], assessments: [], teamId: 'demo-team-u10' },
];
