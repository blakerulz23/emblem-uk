...
const PROTECTED_FILES: Record<string, string> = {
  ...
  'src/lib/pdf-generator.ts': '1b5e35ca7946dabfea6722f1c5316699e339408828d354832bc5c6e129b2866d',
  ...
  //
  // Updated a tenth time to add the new Emerald Edition Custom Collection
  // template: one new import (EmeraldCardArt) and one new front-dispatch
  // branch (`template.family === 'Custom' && template.id === 'custom-emerald'`),
