...
export async function sendSquadInviteEarlyPreviewEmail(params: {
  ...
  const html = `<h2>Your card's been approved</h2><p>Emblem staff have reviewed and approved your child's card for <strong>${team}</strong> — it's now queued for production.</p><p>While you wait for the physical card, you can already preview the digital card and start exploring Player OS.</p><p><a href="${params.claimUrl}" style="display:inline-block;padding:12px 20px;background:#E97435;color:#fff;text-decoration:none;border-radius:8px;font-weight:700">Preview your card</a></p><p style="color:#6b7280;font-size:13px">Payment for this card has already been received. If you weren't expecting this email, you can ignore it.</p>`;
  const text = `Your card's been approved\n\nEmblem staff have reviewed and approved your child's card for ${params.teamName} — it's now queued for production.\n\nWhile you wait for the physical card, you can already preview the digital card and start exploring Player OS.\n\nPreview your card: ${params.claimUrl}\n\nPayment for this card has already been received. If you weren't expecting this email, you can ignore it.`;
